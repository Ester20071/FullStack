...
//deixe alguma entrada ter algum valor (ser uma variável) - var é mais amplo então use var - ao invés de let poderia ser var tbm (Como se fosse o input do python):
